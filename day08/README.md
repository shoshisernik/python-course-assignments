...
1. create a separate environment for the kaggle project to keep all dependencies clean
...
3. Creat a Kaggle account and get your API key
...
5. test that the setup worked
    -test by typing into terminal: kaggle datasets list

    -you should see a list of datasets. 
6. You can then download any particular dataset that you wish to analyze or just run the code provided in this folder, which already does this
